...
const NavigateCard = () => {
  ...
  return (
    <SafeAreaView style={tailwind`bg-white flex-1 justify-between`}>
      ...
      >
        <TouchableOpacity
          style={tailwind`bg-black flex-row w-35 justify-between items-center py-3 px-4 rounded-full`}
          onPress={() => navigation.navigate("RideOptionsCard")}
        >
          <Icon name="car" type="font-awesome" color="white" size={16} />
          <Text style={tailwind`ml-2 text-white text-center`}>
            Get Mechanic
          </Text>
        </TouchableOpacity>
      </View>
